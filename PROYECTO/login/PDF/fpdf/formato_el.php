...
$pdf->multicell(0,6.5,utf8_decode('
        Tengo el agrado de dirigirme a usted, en la oportunidad de presentarle a el Bachiller '.$nombre.', titular de la cédula de identidad '.$nombre.', estudiante de la carrera '.$nombre.', el mencionado Bachiller está autorizado para realizar trámites en la Organización que usted representa, relacionados con la posibilidad de desarrollar en su práctica profesional un proyecto con un mínimo de 480 horas laborales, comprendidas desde 20 de MARZO del 2023 hasta  el 23 de JUNIO del 2023.
