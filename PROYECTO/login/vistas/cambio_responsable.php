...
<span class="text">Ventana -> <a href="cambio_registro.php">Cambio Registro</a> -> Cambio Responsable</span>
<div class="page-content">
    <!-- Sección de Formulario de modal-large -->
    <div class="modal-large-container">
        <div class="formulario-modal-large">
            <h2>Cambio Responsable</h2>
            ...
            <div class="fila-superior">
                <div class="formulario__grupo">
                    ...
                    <input type="text" class="formulario__input" id="nombre-institucion" style="width: 100%;" readonly>
                </div>

                <div class="formulario__grupo">
                    <label class="formulario__label">Responsable anterior</label>
                    <input type="text" class="formulario__input" id="nombre-responsable" style="width: 100%;" readonly>
                </div>
