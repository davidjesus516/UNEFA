...
require 'header.php';
?>
<span class="text">Ventana -> <a href="seguimiento.php">Seguimiento</a> -> Registro Visitas</span>
<div class="page-content">
    ...
    <a href="seguimiento.php" class="btn-link-responsables" style="margin: 1rem 0; display: inline-block;">
