...
<div class="page-content">
        ...
        <div class="formulario-seguimiento">
            ...
            <div class="fila-superior">
                ...
                <div class="formulario__grupo">
                    ...
                    <input type="text" class="formulario__input" id="nombre-estudiante" readonly>
                </div>

                <!-- Grupo Título -->
                <div class="formulario__grupo">
                    <label class="formulario__label">Título Informe <span class="obligatorio">*</span></label>
                    <input type="text" class="formulario__input" id="titulo-informe"
    ...
    <!-- Sección de Tabla de Visitas -->
    <div class="tabla-visitas-container">
        <h3>Registro Histórico de Visitas</h3>
    ...
    <table class="w3-table-all w3-hoverable tabla-principal">
        <thead>
            <tr class="w3-light-grey">
