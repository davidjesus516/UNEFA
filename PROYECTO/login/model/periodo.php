...
class Usuario
{
  ...
  //creo la funcion que me va a consultar todos los datos que exista y me los traera y guardarlos en una variable
    ...
    {try {
        ...
        $consulta = "INSERT INTO `T-INTERNSHIPS_PERIOD`(`DESCRIPTION`, `T_INTERNSHIPS_CODE`, `START_DATE`, 'END_DATE', `CREATION_DATE`, `PERIOD_STATUS`, `STATUS`) VALUES (:DESCRIPTION, :T_INTERNSHIPS_CODE, :START_DATE, :END_DATE, :CREATION_DATE, :PERIOD_STATUS :STATUS)";
        $statement = $this->pdo->prepare($consulta);
        $statement->bindValue(":DESCRIPTION", $DESCRIPTION);
