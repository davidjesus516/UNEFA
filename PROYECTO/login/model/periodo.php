...
class Periodo
{
    ...
    public function insertarPeriodo($ACADEMIC_LAPSE, $T_INTERNSHIPS_CODE, $START_DATE, $END_DATE, $PERIOD_STATUS, $STATUS)
    {
        try {
            ...
            $consulta = "INSERT INTO `T-INTERNSHIPS_PERIOD` (ACADEMIC_LAPSE, T_INTERNSHIPS_CODE, START_DATE, END_DATE, CREATION_DATE, PERIOD_STATUS, STATUS) 
             VALUES (:ACADEMIC_LAPSE, :T_INTERNSHIPS_CODE, :START_DATE, :END_DATE, :CREATION_DATE, :PERIOD_STATUS, :STATUS)";
            $statement = $this->pdo->prepare($consulta);
            $statement->bindValue(":ACADEMIC_LAPSE", $ACADEMIC_LAPSE);
            $statement->bindValue(":T_INTERNSHIPS_CODE", $T_INTERNSHIPS_CODE);
